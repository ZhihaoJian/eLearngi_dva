    ...
    render() {
        ...
        const avatarPopMenu = (
            <div className={styles['avatar-pop-menu']} >
                ...
                <div className={styles['menu-item']} ><Icon type="tool" className={styles['icon']} /><span className={styles['setting-name']}>设置</span></div>
                <div className={styles['menu-item']} onClick={e => this.onLogout(e)}  ><Icon type="logout" /><span className={styles['setting-name']}>登出</span></div>
            </div>
        )
